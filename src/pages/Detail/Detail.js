...
export default function Detail(props) {
  return (
    <div
      style={{
        backgroundImage: `url(https://rapchieuphim.com/photos/8925/ttp_700x1000_kc_14_10_2022_1_.jpg)`,
            ...
            <div className="img-left col-8">
              <div className="row bg-all">
                <div className="col-6 bg">
                  <img src="https://rapchieuphim.com/photos/8925/ttp_700x1000_kc_14_10_2022_1_.jpg" alt="" />
                </div>
                <div className="col-6 " >
                  <p
                    style={{
                  ...
                  >
                    Tên Phim: Tấm vé đến từ thiên đường
                  </p>
                  <p
                    style={{
                      fontSize: "15px",
            ...
            <Tabs defaultActiveKey="1" centered>
              ...
              <TabPane tab="Đánh Giá" key={3}>
                <div className="d-flex justify-content-center mt-4">
                  ...
                  >
                    <img width={20} src="../img/star.png" allowHalf alt=""/>
                    <img width={20} src="../img/star.png" allowHalf alt=""/>
                    <img width={20} src="../img/star.png" allowHalf alt=""/>
                    <img width={20} src="../img/star.png" allowHalf alt=""/>
                    <img width={20} src="../img/star.png" allowHalf alt=""/>
